...
class JWTAudienceError(AgentOrchestratorError):
    """Raised when JWT audience validation fails."""
    def __init__(self, expected: str, actual: str):
        super().__init__(f"JWT audience mismatch: expected '{expected}', got '{actual}'")
